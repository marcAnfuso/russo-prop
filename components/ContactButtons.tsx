...
export default function ContactButtons({
  ...
  const btnBase = `inline-flex items-center justify-center rounded-full transition-transform duration-200 hover:scale-110 ${sizeClasses[size]}`;
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <a
        ...
        className={`${btnBase} bg-gray-400 text-white`}
        onClick={(e) => e.stopPropagation()}
      >

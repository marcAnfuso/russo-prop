    ...
    <>
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="w-full lg:w-[65%] space-y-6">
          ...
          {/* Operation badge + Vendimos + apto crédito/financiación/permuta */}
          <div className="flex items-center gap-2 flex-wrap">
            ...
            {property.aptoCredito && (
              <span className="inline-flex items-center rounded-full ring-1 ring-inset ring-emerald-200 bg-emerald-50 text-emerald-700 px-3 py-1 text-xs font-semibold">
                Apto crédito
              </span>
            )}
            {property.aptoFinanciacion && (
              <span className="inline-flex items-center rounded-full ring-1 ring-inset ring-blue-200 bg-blue-50 text-blue-700 px-3 py-1 text-xs font-semibold">
                Financiación
              </span>
            )}
            {property.aptoPermuta && (
              <span className="inline-flex items-center rounded-full ring-1 ring-inset ring-violet-200 bg-violet-50 text-violet-700 px-3 py-1 text-xs font-semibold">
                Permuta
              </span>
            )}

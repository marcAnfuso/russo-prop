...
/**
 * Lluvia sutil de papelitos celeste/blanco.
 * Dispara al montar y se apaga sola tras `duration` ms.
 * Para re-disparar, remontar con una `key` distinta (o renderizar
 * condicionalmente con un contador). No usa prop `active` para evitar
...
export default function MundialConfetti({
  ...
  // Determinístico (makePieces deriva posiciones con Math.sin del índice):
  // puro para el linter y suficientemente "aleatorio" a la vista.

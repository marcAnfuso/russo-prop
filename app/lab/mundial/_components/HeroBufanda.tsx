...
import Bufanda from "./Bufanda";

/**
 * Hero con una bufanda de hincha atada sobre la palabra "hogar".
 * Resto idéntico al Hero original (mismo kicker, mismo copy) — el toque
 * mundialista es sólo la bufanda.
 */
export default function HeroBufanda() {
  return (

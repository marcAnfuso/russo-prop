...
/**
 * Hero con una bufanda de hincha FOTO-REAL (generada con SDXL local +
 * recortada con rembg) drapeada sobre la palabra "hogar".
 *
 * La posición/escala se controla con las clases del <img>. Está pensada para
 * iterar a ojo: tunear top/width hasta que "abrace" la palabra.
 */
export default function HeroBufandaFoto() {
  return (
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-4 sm:px-6 lg:px-8 w-full max-w-3xl mx-auto">
        ...
        >
          ...
          <span className="relative inline-block">
            <span className="relative z-10">hogar</span>
            {/* Bufanda foto-real drapeada sobre la palabra */}
            <img
              src="/lab/mundial/bufanda.png"
              alt=""
              aria-hidden="true"
              className="pointer-events-none select-none absolute left-[66%] -top-[0.32em] w-[58%] max-w-none z-20 drop-shadow-[0_6px_10px_rgba(0,0,0,0.45)]"
            />
          </span>
          <br />
          <span className="relative inline-block">
